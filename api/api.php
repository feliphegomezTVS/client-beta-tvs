...
namespace Tqdev\PhpCrudApi {
    ...
    $config = new Config([
        'driver' => 'mysql',
        'address' => '181.129.103.141',
        'port' => '3306',
        'username' => 'fg', //admin_ubackbtvs
        'password' => 'Celeste.1035429360.Samael', //aN9GcSVCs8ni0kDE3bThGi3yu3AWrVtpurTthwwN
        'database' => 'tvs_obd2ip_beta',
        'debug' => true,
		
		'middlewares' => 'cors,dbAuth,authorization,sanitation,validation,multiTenancy,customization', //xsrf jwtAuth ipAddress pageLimits   
		'cacheType' => 'NoCache',
		'openApiBase' => '{"info":{"title":"OBD2IP-TVS","version":"1.0.0"}}',
		
		'dbAuth.mode' => 'optional', // optional,required
